...
<head>
  ...
  <style>
body {
  background-image: url("../imagenes/paginaprincipal.jpg");  
...
<body>
  <div class="container">
      ...
      <tbody>
        ...
        foreach ($filas as $fila) {
          ...
          <tr>
            ...
            <td class="text-right">
              <a class="btn btn-secondary btn-sm botonimprimir" role="button" href="#" data-codigo="<?php echo $fila['codigo'] ?>">Imprimir PDF</a>
              <a class="btn btn-secondary btn-sm botonborrar" role="button" href="#" data-codigo="<?php echo $fila['codigo'] ?>">Borrar</a>
            </td>
          </tr>
        <?php
        }
    ...
    <button type="button" id="btnNuevaFactura" class="btn btn-primary">Emitir factura</button>
  </div>
