  ...
  <div class="container">
    ...
    <div class="row mt-4">
      <div class="col-md">
        ...
        <button type="button" id="btnAgregarProducto" class="btn btn-outline-danger">Agregar Producto</button>
        <button type="button" id="btnTerminarFactura" class="btn btn-outline-warning">Terminar Factura</button>
		<hr>
	<div class="alert alert-primary" role="alert">
  Para volver al menu principal ---> <a href="http://c2341303.ferozo.com/api3/parcial2/" class="alert-link">Volver</a>
      </div>
    </div>
